                    ...
                    <div className="cart-full">
                        <div className="full-description">
                            ...
                            <div className="delete-item">
                                <svg width="14" height="16" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs>
                        ...
                        <button className="text-center text-white font-bold py-2 px-4 rounded" style={{backgroundColor:'hsl(26, 100%, 55%)'}}>Checkout</button>
                    </div>
                </div>
            </div>
        </div>
