            ...
            <div className="detail-content">
                ...
                <div className="detail-image">
                    ...
                    <div className="list-image">
                        <div className="image-item" onClick={()=> setIsOpen(true)}>
                            <img src="images/image-product-1.jpg" alt="Sneakers One"/>
                        </div>
                ...
                <div className="detail-description">
                    ...
                    <div className="product-quantity">
                        ...
                        <div className="add-button">
                            <button className="flex items-center text-white font-bold py-2 px-14 rounded" style={{backgroundColor:'hsl(26, 100%, 55%)'}}>
